...
- (id<WalletApiKotlinx_coroutines_coreJob>)subscribeOnEach:(void (^)(T _Nullable))onEach onComplete:(void (^)(void))onComplete onThrow:(void (^)(WalletApiKotlinThrowable *))onThrow __attribute__((swift_name("subscribe(onEach:onComplete:onThrow:)")));
@property (readonly) id<WalletApiKotlinx_coroutines_coreCoroutineScope> scope __attribute__((swift_name("scope")));
@end;
